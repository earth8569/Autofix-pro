...
const TRANSLATIONS = {
  en: {
    ...
    backupExportDesc:       'Download every record as a single JSON file. Keep it on OneDrive, a USB stick, or email to yourself.',
    backupExportBtn:        'Download backup (.json)',
    backupExportDone:       'Backup downloaded',
    backupImportTitle:      'Import',
    backupImportDesc:       'Replaces ALL current data with the contents of the file. A safety snapshot is saved first so you can undo.',
    backupImportBtn:        'Choose file to restore…',
    backupImportConfirm:    'Replace all current data with this file? A safety snapshot is taken first.',
    backupImportBadJson:    'File is not valid JSON',
    backupImportBadShape:   'File does not look like an AutoFix Pro export',
    backupImportReadFail:   'Could not read file',
    backupImportDone:       'Data restored from file',
    backupServerTitle:      'Server snapshots',
    backupServerDesc:       'Automatic backups stored next to your data file. Restoring snapshots your current file first.',
    backupServerOffline:    'Server not reachable — start.py may not be running.',
    backupNone:             'No server backups yet. They appear after your first save.',
    backupRestoreBtn:       'Restore',
    backupRestoreConfirm:   'Restore from {name}? Your current data will be snapshotted first.',
    backupRestoreDone:      'Restored — reloading…',
    backupRestoreFail:      'Restore failed',
    backupHealthTitle:      'Status',
    backupHealthFile:       'Data file',
    backupHealthCount:      'Snapshots kept',
    backupHealthLocal:      'Browser mirror',
    backupHealthLocalEmpty: 'empty',
    backupHealthNoFile:     'No data file yet — a save will create one.',
    recoveryTitle:          'Data file unreadable',
    recoveryHeadline:       'Your live data file could not be read.',
    recoveryExplain:        'Nothing was lost — recent saves are kept as snapshots. Pick one below to restore. The current (corrupt) file will be archived first.',
    recoveryLocalTitle:     'Browser copy',
    recoveryLocalDesc:      'This browser has its own mirror of your data. If the server snapshots above look too old, restore from here.',
    recoveryLocalBtn:       'Restore from browser mirror',
    recoveryLocalEmpty:     'Browser mirror is empty',
    recoveryLocalConfirm:   'Restore from this browser\'s mirror?',
    recoveryImportTitle:    'Have your own backup?',
  },
  ...
  th: {
    ...
    backupExportTitle:      'ส่งออก',
    backupExportDesc:       'ดาวน์โหลดข้อมูลทั้งหมดเป็นไฟล์ JSON เก็บไว้ใน OneDrive, USB หรือส่งอีเมลถึงตัวเอง',
    backupExportBtn:        'ดาวน์โหลดไฟล์สำรอง (.json)',
    backupExportDone:       'ดาวน์โหลดไฟล์สำรองแล้ว',
    backupImportTitle:      'นำเข้า',
    backupImportDesc:       'จะแทนที่ข้อมูลปัจจุบันทั้งหมดด้วยเนื้อหาในไฟล์ ระบบจะบันทึกสำเนาปัจจุบันไว้ให้ก่อน เผื่อต้องการย้อนกลับ',
    backupImportBtn:        'เลือกไฟล์เพื่อกู้คืน…',
    backupImportConfirm:    'แทนที่ข้อมูลปัจจุบันทั้งหมดด้วยไฟล์นี้? ระบบจะบันทึกสำเนาไว้ก่อน',
    backupImportBadJson:    'ไฟล์ไม่ใช่ JSON ที่ถูกต้อง',
    backupImportBadShape:   'ไฟล์ไม่ตรงรูปแบบของ AutoFix Pro',
    backupImportReadFail:   'อ่านไฟล์ไม่สำเร็จ',
    backupImportDone:       'กู้คืนข้อมูลจากไฟล์แล้ว',
    backupServerTitle:      'สำเนาที่เซิร์ฟเวอร์',
    backupServerDesc:       'สำเนาที่ระบบสร้างอัตโนมัติ เก็บไว้ข้างไฟล์ข้อมูลจริง การกู้คืนจะบันทึกสำเนาปัจจุบันไว้ให้ก่อน',
    backupServerOffline:    'ไม่สามารถติดต่อเซิร์ฟเวอร์ได้ — อาจยังไม่ได้เปิด start.py',
    backupNone:             'ยังไม่มีสำเนาสำรอง จะปรากฏหลังจากบันทึกครั้งแรก',
    backupRestoreBtn:       'กู้คืน',
    backupRestoreConfirm:   'กู้คืนจาก {name}? ข้อมูลปัจจุบันจะถูกบันทึกเป็นสำเนาไว้ก่อน',
    backupRestoreDone:      'กู้คืนแล้ว กำลังโหลดใหม่…',
    backupRestoreFail:      'กู้คืนไม่สำเร็จ',
    backupHealthTitle:      'สถานะ',
    backupHealthFile:       'ไฟล์ข้อมูล',
    backupHealthCount:      'จำนวนสำเนา',
    backupHealthLocal:      'สำเนาในเบราว์เซอร์',
    backupHealthLocalEmpty: 'ว่าง',
    backupHealthNoFile:     'ยังไม่มีไฟล์ข้อมูล จะถูกสร้างเมื่อบันทึกครั้งแรก',
    recoveryTitle:          'อ่านไฟล์ข้อมูลไม่ได้',
    recoveryHeadline:       'ไม่สามารถอ่านไฟล์ข้อมูลหลักได้',
    recoveryExplain:        'ข้อมูลไม่ได้หาย — สำเนาสำรองล่าสุดถูกเก็บไว้ เลือกจากรายการด้านล่างเพื่อกู้คืน ไฟล์ปัจจุบันจะถูกเก็บไว้เป็นสำเนาก่อน',
    recoveryLocalTitle:     'สำเนาในเบราว์เซอร์',
    recoveryLocalDesc:      'เบราว์เซอร์นี้มีสำเนาข้อมูลของตัวเอง ถ้าสำเนาที่เซิร์ฟเวอร์เก่าเกินไป ให้กู้คืนจากที่นี่',
    recoveryLocalBtn:       'กู้คืนจากสำเนาในเบราว์เซอร์',
    recoveryLocalEmpty:     'ไม่มีสำเนาในเบราว์เซอร์',
    recoveryLocalConfirm:   'กู้คืนจากสำเนาในเบราว์เซอร์นี้?',
    recoveryImportTitle:    'มีไฟล์สำรองของตัวเอง?',
  },
};
